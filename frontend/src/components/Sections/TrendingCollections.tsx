          ...
          <div
            ...
            <div className='flex transition-transform duration-700 ease-out select-none' style={{transform: `translateX(-${currentIndex * slideWidth}%)`, userSelect: 'none', WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none'}}>
              {[...collections, ...collections].map((collection, index) => (
                <div key={`${collection.id}-${index}`} style={{width: `${slideWidth}%`, userSelect: 'none', WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none'}} className='flex-shrink-0 px-3 select-none' data-aos="zoom-in" data-aos-delay={index * 100}>
            ...
            <div className='flex justify-center mt-8 space-x-2 select-none' style={{userSelect: 'none', WebkitUserSelect: 'none', MozUserSelect: 'none', msUserSelect: 'none'}} data-aos="fade-up">
