    ...
    if (searchQuery.trim() !== '') {
      ...
      filtered = filtered.filter(nft => 
        ...
        (nft.attributes?.some(attr => 
          ...
          (typeof attr.value === 'number' && attr.value.toString().includes(query))
        ))
      );
    }
  ...
  if (error) {
    return (
      <div className="p-4 bg-red-900/30 text-red-200 rounded-lg">
        <p>{error}</p>
        <button 
          onClick={() => setInitialLoading(true)} 
      ...
      <div className="mb-4 space-y-3">
        ...
        <div className="relative">
          <input
            ...
            placeholder="Rechercher par nom, ID, numéro de série ou attribut..."
