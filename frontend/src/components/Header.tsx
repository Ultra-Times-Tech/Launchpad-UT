      ...
      <div className='container mx-auto px-4 py-4'>
        <div className='flex items-center justify-between'>
          ...
          <nav className='hidden md:flex items-center space-x-8'>
            ...
            <Link to='/authors' className='hover:text-blue-600 transition-colors'>
              Authors
            </Link>
          ...
          <div className='flex items-center space-x-6'>
            ...
            <button onClick={handleConnectWallet} className={`px-4 py-2 rounded-lg font-medium transition-colors ${isWalletConnected ? 'bg-green-600 text-white hover:bg-green-700' : 'bg-purple-600 text-white hover:bg-purple-700'}`}>
